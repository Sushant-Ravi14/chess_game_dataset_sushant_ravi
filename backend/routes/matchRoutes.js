...
router.post('/bulk-upload', matchController.bulkUpload);
router.patch('/bulk-update', matchController.bulkUpdate);
router.delete('/bulk-delete', matchController.bulkDelete);
router.patch('/bulk/archive', matchController.bulkArchive);
router.patch('/bulk/restore', matchController.bulkRestore);
