...
router.post('/', protect, validateCreateMatch, matchController.createMatch);
...
router.patch('/:matchId/archive', protect, matchController.archiveMatch); 
router.patch('/:matchId/restore', protect, matchController.restoreMatch); 
router.get('/:matchId', matchController.getMatchById);
router.put('/:matchId', protect, validateCreateMatch, matchController.updateMatch);
router.patch('/:matchId', protect, validateUpdateMatch, matchController.updateMatch);
